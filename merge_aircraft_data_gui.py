    ...
    def run_help(self):
        messagebox.showinfo(
            ...
            (
                ...
                " - If both have a Localization folder (Cmn.dat + A–M.dat), source localization is merged into target.\n\n"
                ...
                " - Localization: new strings are added; empty target strings are filled from source; conflicting strings are listed in the log for manual edit.\n\n"
